...
private:
	...
	sScript *Script_Motion(sScript *ScriptPtr);
	sScript *Script_SetFaceToFace(sScript *ScriptPtr);
	sScript *Script_LetNPCAttack(sScript *Script);
	sScript *Script_IfKillThen(sScript *Script);
	sScript *Script_IfAllWasKilled(sScript *Script);
	sScript *Script_MoveCamera(sScript *Script);
	sScript *Script_MoveCameraToChar(sScript *Script);
	sScript *Script_SetPCControlCamera(sScript *Script);
	sScript *Script_BlackScreenMessage(sScript *Script);
	sScript *Script_PlayMP3(sScript *Script);
	sScript *Script_StopMP3(sScript *Script);
	sScript *Script_PlayAVI(sScript *Script);
